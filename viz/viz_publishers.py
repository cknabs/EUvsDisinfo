...
from viz.util import plot_graph, sort
...
if __name__ == '__main__':
    ...
    plot_graph(res_social, percentile_cutoff=0)
    plot_graph(res_content, percentile_cutoff=0)
    plot_graph(res_topic, percentile_cutoff=0.9)
